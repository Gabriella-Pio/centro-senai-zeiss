...
export function getAllowedActions(request: QuoteRequest, _currentUserRole?: UserRole): RequestAction[] {
...
export function getAssignableUsers() {
  return DEMO_USERS.filter((user) => user.active && (user.role === "VALIDADOR" || user.role === "TECNICO"));
}

export function assignRequest(request: QuoteRequest, userId: string, userName: string): QuoteRequest {
